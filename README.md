...
| **Funding Round** | Latest known round (`Seed`, `Series <Letter>`, or `Public`) |
| **Amount Raised** | Disclosed amount from the cited event |
| **Careers Page** | Direct link to open roles |
| **Sources** | Public links used for headcount/funding |

## Companies included

LangChain · Factory.ai · Databricks · GitHub · GitLab · Stainless · Mintlify · Artificial Analysis · OpenRouter
